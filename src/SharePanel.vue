...
export default {
  ...
  async created() {
    ...
    this.whatsappUrl = 'whatsapp://send?text=' + encodedText + '%20' + encodedUrl
    this.hackerNewsUrl = 'https://news.ycombinator.com/submitlink?u=' + encodedUrl + amp + 't=' + encodedText
...
<template>
  <div>
    ...
    <a class="resp-sharing-button__link" :href="facebookUrl"
